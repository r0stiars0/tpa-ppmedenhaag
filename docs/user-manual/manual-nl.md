...
> **Nieuwe gezinnen** worden ingeschreven via het jaarlijkse Google-inschrijfformulier ("Daftar Ulang"). U vult daarin per kind de naam en geboortedatum in, en uw eigen naam en e-mailadres (u moet bij Google ingelogd zijn). Er staat een optioneel vinkje voor het privacybeleid — aanvinken mag, maar de inschrijving werkt ook zonder. Kort daarna ontvangt u een **uitnodigingsmail**; als u daarna met datzelfde Google-account inlogt, staat uw account al klaar en komt u meteen in de app. Stuurt u het formulier per ongeluk nog een keer in voor hetzelfde kind, dan verandert er niets — de bestaande gegevens worden bijgewerkt. De beheerder deelt uw kind daarna nog in bij een groep. Vult u op het formulier ook het **e-mailadres van uw kind** in, dan krijgt uw kind een eigen uitnodiging om zelf in te loggen en alleen de eigen gegevens te bekijken (of dat lukt, hangt af van de leeftijdsgrens van Google).
