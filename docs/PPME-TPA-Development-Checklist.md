...
created the profile. A request that is never approved is left in place;
the admin *reject* action that clears those is **ADR-039**, a separate
change (a Netlify Function, no migration). Six i18n keys per locale;
